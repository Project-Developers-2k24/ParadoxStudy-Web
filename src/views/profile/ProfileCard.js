      ...
      >
        ...
        <Grid item sx={{ p: "1.5rem 0rem", textAlign: "center" }}>
          ...
          <Badge
            ...
            badgeContent={
              <PhotoCameraIcon
                onClick={handleCameraIconClick} // Attach onClick event handler
                sx={{
          ...
          >
            <Avatar
              ...
              src={profileImage} // Use profileImage state as src
            ></Avatar>
          </Badge>
        ...
        <input
          type="file"
          id="imageInput"
          accept="image/jpeg" // Limit to JPG files
          style={{ display: "none" }}
          onChange={handleImageChange} // Attach onChange event handler
        />
      </Grid>
    </Card>
  );
