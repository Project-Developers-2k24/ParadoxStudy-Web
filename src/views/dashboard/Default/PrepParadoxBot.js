...
const ChatBot = () => {
  ...
  // useEffect(() => {
  //   // Dynamically import the Mermaid library from the CDN
  //   import('https://cdn.jsdelivr.net/npm/mermaid@10/dist/mermaid.esm.min.mjs')
  //     .then((mermaid) => {
  //       // Initialize Mermaid globally
  //       mermaid.initialize({ startOnLoad: true });

  //       // Try rendering the Mermaid charts globally for all `.mermaid` class elements
  //       try {
  //         mermaid.contentLoaded(); // This looks for all `.mermaid` class elements and renders them
  //       } catch (error) {
  //         console.error('Error rendering Mermaid chart:', error);
  //       }
  //     })
  //     .catch((err) => console.error('Error loading Mermaid library:', err));
